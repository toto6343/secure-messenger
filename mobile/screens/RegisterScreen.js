...
export default function RegisterScreen({ navigation }) {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      // Register user
      const response = await authAPI.register(username, email, password, publicKey);
      ...
      Alert.alert(
        '회원가입 완료',
        '환영합니다! 이제 안전하게 메시지를 주고받을 수 있습니다.',
        [
          {
            text: '확인',
            onPress: () => {
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <View style={styles.content}>
          ...
          <View style={styles.logoContainer}>
            ...
            <Text style={styles.subtitle}>안전한 메신저 시작하기</Text>
          </View>
